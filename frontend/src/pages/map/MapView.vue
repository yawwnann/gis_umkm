<template>
  <div class="h-screen w-screen relative overflow-hidden font-sans bg-slate-50 dark:bg-[#111315] text-slate-900 dark:text-[#F0F0F0] transition-colors duration-200">
    ...
    <div :class="[
      ...
      >
        <Layers class="w-5 h-5 text-slate-700 dark:text-[#F0F0F0] group-hover:text-[#F59E0B] transition-colors" />
      </button>
      ...
      >
        ...
        <div class="space-y-3">
          <label class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest">Tampilan Titik UMKM</label>
          <div class="flex flex-col bg-slate-100 dark:bg-[#111315] p-1 rounded-xl border border-slate-200 dark:border-[#2A2E33] transition-colors space-y-1">
            <button 
              @click="setMapMode('markers')" 
              :class="['w-full py-2 px-3 text-xs font-bold rounded-lg transition-all text-left', umkmViewMode === 'markers' ? 'bg-[#F59E0B] text-[#111315] shadow-md' : 'text-slate-500 dark:text-[#6F767E] hover:text-slate-900 dark:hover:text-white']"
            >
              • Marker & Cluster
            </button>
            <button 
              @click="setMapMode('heatmap_density')" 
              :class="['w-full py-2 px-3 text-xs font-bold rounded-lg transition-all text-left', umkmViewMode === 'heatmap_density' ? 'bg-[#F59E0B] text-[#111315] shadow-md' : 'text-slate-500 dark:text-[#6F767E] hover:text-slate-900 dark:hover:text-white']"
            >
              🔥 Heatmap Persebaran
            </button>
            <button 
              @click="setMapMode('heatmap_potential')" 
              :class="['w-full py-2 px-3 text-xs font-bold rounded-lg transition-all text-left', umkmViewMode === 'heatmap_potential' ? 'bg-[#F59E0B] text-[#111315] shadow-md' : 'text-slate-500 dark:text-[#6F767E] hover:text-slate-900 dark:hover:text-white']"
            >
        ...
        <!-- Layers Toggle -->
        <div class="space-y-4">
          <label class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest">Layer Spasial</label>
          
          <div class="grid grid-cols-1 gap-2.5">
            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.umkm" @change="toggleLayer('umkm')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
              <span class="font-medium">UMKM Kuliner</span>
            </label>
            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.village" @change="toggleLayer('village')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
              <span class="font-medium">Batas Kelurahan</span>
            </label>

            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.settlement" @change="toggleLayer('settlement')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
              <span class="font-medium">Kawasan Pemukiman</span>
            </label>
            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.trading" @change="toggleLayer('trading')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
              <span class="font-medium">Fasilitas Niaga</span>
            </label>

            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.school" @change="toggleLayer('school')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
              <span class="font-medium">Fasilitas Pendidikan</span>
            </label>
            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.gov" @change="toggleLayer('gov')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
              <span class="font-medium">Fasilitas Pemerintahan</span>
            </label>
            <label class="flex items-center space-x-3 text-sm text-slate-700 dark:text-[#F0F0F0] cursor-pointer p-2 hover:bg-slate-50 dark:hover:bg-[#22262A] rounded-lg transition-colors">
              <input type="checkbox" v-model="visibleLayers.tourism" @change="toggleLayer('tourism')" class="h-4 w-4 text-[#F59E0B] rounded border-slate-300 dark:border-[#2A2E33] bg-white dark:bg-[#111315] focus:ring-[#F59E0B] focus:ring-offset-[#1A1D1F]" />
        ...
        <!-- Basemap Selector -->
        <div class="space-y-3">
          <label class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest">Basemap</label>
          <div class="flex bg-slate-100 dark:bg-[#111315] p-1 rounded-xl border border-slate-200 dark:border-[#2A2E33] transition-colors">
            <button 
              @click="changeBasemap('streets')" 
              :class="['flex-1 py-2 text-xs font-bold rounded-lg transition-all', basemap === 'streets' ? 'bg-[#F59E0B] text-[#111315] shadow-md' : 'text-slate-500 dark:text-[#6F767E] hover:text-slate-900 dark:hover:text-white']"
            >
              Streets
            </button>
            <button 
              @click="changeBasemap('satellite')" 
              :class="['flex-1 py-2 text-xs font-bold rounded-lg transition-all', basemap === 'satellite' ? 'bg-[#F59E0B] text-[#111315] shadow-md' : 'text-slate-500 dark:text-[#6F767E] hover:text-slate-900 dark:hover:text-white']"
            >
              Satellite
            </button>
          </div>
    ...
    <button
      ...
      class="absolute left-4 top-4 z-30 h-11 w-11 bg-[#F59E0B] hover:bg-[#D97706] text-[#111315] rounded-xl flex items-center justify-center shadow-lg shadow-[#F59E0B]/30 transition-all hover:scale-105 active:scale-95"
      title="Buka Panel"
    >
    ...
    <aside :class="[
      ...
      sidebarOpen ? 'translate-x-0' : '-translate-x-full max-md:-translate-x-full md:translate-x-0'
    ]">
      <!-- Header -->
      <div class="p-6 border-b border-slate-200/50 dark:border-white/5 bg-white/40 dark:bg-black/20 flex items-center justify-between">
        <div class="flex items-center space-x-3">
          <div class="h-10 w-10 rounded-xl flex items-center justify-center">
            <img src="/src/assets/logo.png" alt="GIS UMKM" class="h-10 w-10 rounded-xl" />
          </div>
          <h1 class="font-extrabold text-lg tracking-tight text-slate-900 dark:text-white">GIS UMKM</h1>
        </div>
      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
        ...
        <!-- Search -->
        <div class="space-y-3">
          <label class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest">Pencarian</label>
          <div class="relative">
          ...
          >
            ...
            >
              <div>
                <div class="font-bold text-slate-900 dark:text-white group-hover:text-[#D97706] dark:group-hover:text-[#F59E0B] transition-colors">{{ umkm.name }}</div>
                <div class="text-slate-500 dark:text-[#6F767E] text-xs mt-0.5">{{ umkm.category }} - {{ umkm.village_name }}</div>
              </div>
              <ChevronRight class="h-4 w-4 text-slate-400 dark:text-[#6F767E] group-hover:text-[#D97706] dark:group-hover:text-[#F59E0B] transition-colors" />
            </button>
          </div>
        </div>
        ...
        <!-- Filters -->
        <div class="space-y-4">
          <label class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest">Filter Kriteria</label>
          
          <div class="space-y-1.5">
            <span class="text-xs font-semibold text-slate-700 dark:text-[#F0F0F0]">Wilayah Kelurahan</span>
            <select 
          ...
          <div class="space-y-1.5">
            <span class="text-xs font-semibold text-slate-700 dark:text-[#F0F0F0]">Kategori Kuliner</span>
            <select 
        ...
        <div class="space-y-4 pt-2">
          <label class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest border-b border-slate-200/50 dark:border-[#2A2E33]/50 pb-2">Statistik Area Ini</label>
          
          <div class="grid grid-cols-2 gap-3">
            <div class="bg-gradient-to-br from-slate-100 to-slate-50 dark:from-[#22262A] dark:to-[#1A1D1F] p-3 rounded-2xl border border-slate-200/50 dark:border-[#2A2E33]/50 flex flex-col justify-between shadow-sm">
              <span class="text-[10px] font-bold text-slate-400 dark:text-[#6F767E] uppercase">Total UMKM</span>
              <span class="text-2xl font-black text-slate-800 dark:text-white mt-1">{{ mapStats.total }}</span>
            </div>
            
            <div class="bg-gradient-to-br from-[#F59E0B]/10 to-transparent p-3 rounded-2xl border border-[#F59E0B]/20 flex flex-col justify-between shadow-sm relative overflow-hidden">
              <Activity class="absolute right-[-10px] bottom-[-10px] w-12 h-12 text-[#F59E0B]/10" />
              <span class="text-[10px] font-bold text-[#D97706] dark:text-[#F59E0B] uppercase">Rata-rata Potensi</span>
              <span class="text-2xl font-black text-slate-800 dark:text-white mt-1 z-10">{{ mapStats.avgPotential }}</span>
            </div>
          </div>

          <div class="bg-slate-100 dark:bg-[#22262A] p-3.5 rounded-2xl border border-slate-200/50 dark:border-[#2A2E33]/50 shadow-sm flex items-center justify-between">
            <div class="flex items-center space-x-2.5 w-full">
              <div class="p-2 bg-white dark:bg-[#1A1D1F] rounded-xl shadow-sm shrink-0"><Store class="w-4 h-4 text-[#F59E0B]"/></div>
              <div class="flex flex-col min-w-0 flex-1">
                <span class="text-[10px] font-bold text-slate-400 dark:text-[#6F767E] uppercase">Kategori Dominan</span>
                <span class="text-sm font-bold text-slate-800 dark:text-white truncate">{{ mapStats.topCategory }}</span>
              </div>
            </div>
          </div>

          <!-- Informasi Kelurahan -->
          <div v-if="selectedVillage" class="bg-white/50 dark:bg-[#1A1D1F]/50 p-4 rounded-2xl border border-slate-200/50 dark:border-[#2A2E33]/50 shadow-sm space-y-3">
            <span class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest mb-1">Infrastruktur {{ selectedVillage }}</span>
            <div class="space-y-2.5">
              <div class="flex items-center justify-between text-xs font-bold">
                <span class="flex items-center text-slate-600 dark:text-[#6F767E]"><Users class="w-3.5 h-3.5 mr-2" /> Penduduk</span>
                <span class="text-slate-800 dark:text-white">{{ mapStats.population.toLocaleString('id-ID') }} Jiwa</span>
              </div>
              <div class="flex items-center justify-between text-xs font-bold">
                <span class="flex items-center text-slate-600 dark:text-[#6F767E]"><GraduationCap class="w-3.5 h-3.5 mr-2" /> Sekolah</span>
                <span class="text-slate-800 dark:text-white">{{ mapStats.schoolsCount }} Unit</span>
              </div>
              <div class="flex items-center justify-between text-xs font-bold">
                <span class="flex items-center text-slate-600 dark:text-[#6F767E]"><Landmark class="w-3.5 h-3.5 mr-2" /> Pemerintahan</span>
                <span class="text-slate-800 dark:text-white">{{ mapStats.govCount }} Unit</span>
              </div>
            </div>
          </div>

          <!-- Indikator Potensi -->
          <div class="bg-white/50 dark:bg-[#1A1D1F]/50 p-4 rounded-2xl border border-slate-200/50 dark:border-[#2A2E33]/50 shadow-sm space-y-3">
            <span class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest mb-1">Sebaran Potensi Ekonomi</span>
            
            <div class="space-y-2.5">
              <div class="flex items-center justify-between text-xs font-bold">
                <span class="flex items-center text-emerald-600 dark:text-emerald-400"><span class="w-2 h-2 rounded-full bg-emerald-500 mr-2 shadow-[0_0_8px_rgba(16,185,129,0.5)]"></span>Tinggi</span>
                <span class="text-slate-800 dark:text-white bg-slate-100 dark:bg-[#22262A] px-2 py-0.5 rounded-md">{{ mapStats.levelTinggi }}</span>
              </div>
              <div class="flex items-center justify-between text-xs font-bold">
                <span class="flex items-center text-amber-600 dark:text-amber-400"><span class="w-2 h-2 rounded-full bg-amber-500 mr-2 shadow-[0_0_8px_rgba(245,158,11,0.5)]"></span>Sedang</span>
                <span class="text-slate-800 dark:text-white bg-slate-100 dark:bg-[#22262A] px-2 py-0.5 rounded-md">{{ mapStats.levelSedang }}</span>
              </div>
              <div class="flex items-center justify-between text-xs font-bold">
                <span class="flex items-center text-rose-600 dark:text-rose-400"><span class="w-2 h-2 rounded-full bg-rose-500 mr-2 shadow-[0_0_8px_rgba(244,63,94,0.5)]"></span>Rendah</span>
                <span class="text-slate-800 dark:text-white bg-slate-100 dark:bg-[#22262A] px-2 py-0.5 rounded-md">{{ mapStats.levelRendah }}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="routingActive && routeInfo" class="p-4 bg-[#F59E0B]/10 border border-[#F59E0B]/20 rounded-xl space-y-3">
          <div class="flex items-center justify-between border-b border-[#F59E0B]/20 pb-2">
            <label class="block text-[10px] font-bold text-slate-700 dark:text-[#F59E0B] uppercase tracking-widest flex items-center space-x-1.5">
              <Navigation class="h-3.5 w-3.5" />
              <span>Info Rute</span>
            </label>
            <button @click="clearRoute" class="text-slate-500 dark:text-[#6F767E] hover:text-slate-900 dark:hover:text-white p-1 rounded">
              <X class="h-3.5 w-3.5" />
            </button>
          </div>
          ...
          <div class="text-xs space-y-2">
            <div class="flex justify-between items-center">
              <span class="text-slate-600 dark:text-[#6F767E] font-medium">Jarak Tempuh:</span>
              <span class="font-bold text-slate-900 dark:text-white bg-white dark:bg-[#22262A] px-2 py-1 rounded border border-slate-200 dark:border-transparent">{{ routeInfo.distance_km }} Km</span>
            </div>
            <div class="flex justify-between items-center">
              <span class="text-slate-600 dark:text-[#6F767E] font-medium">Estimasi Waktu:</span>
              <span class="font-bold text-slate-900 dark:text-white bg-white dark:bg-[#22262A] px-2 py-1 rounded border border-slate-200 dark:border-transparent">{{ routeInfo.duration_min }} Menit</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Map Legend -->
      <div class="p-6 border-t border-slate-200 dark:border-[#2A2E33] bg-slate-50/80 dark:bg-[#111315]/80 transition-colors">
        <span class="block text-[10px] font-bold text-slate-500 dark:text-[#6F767E] uppercase tracking-widest mb-3">Legenda Potensi Lokasi</span>
        <div class="flex justify-between">
          <div class="flex items-center space-x-2 text-xs">
            <span class="h-3 w-3 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)] block"></span>
            <span class="font-medium text-slate-700 dark:text-[#F0F0F0]">Tinggi</span>
          </div>
          <div class="flex items-center space-x-2 text-xs">
            <span class="h-3 w-3 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.5)] block"></span>
            <span class="font-medium text-slate-700 dark:text-[#F0F0F0]">Sedang</span>
          </div>
          <div class="flex items-center space-x-2 text-xs">
            <span class="h-3 w-3 rounded-full bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.5)] block"></span>
            <span class="font-medium text-slate-700 dark:text-[#F0F0F0]">Rendah</span>
          </div>
        </div>
      </div>
    </aside>
    ...
    <!-- Loading Overlay -->
    <div v-if="isLoading" class="absolute inset-0 z-[1000] bg-slate-900/60 backdrop-blur-sm flex flex-col items-center justify-center transition-all duration-300">
      <div class="bg-white dark:bg-[#1A1D1F] p-8 rounded-3xl shadow-2xl flex flex-col items-center max-w-sm text-center border border-slate-200 dark:border-[#2A2E33]">
        <div class="relative w-16 h-16 mb-6">
          <div class="absolute inset-0 border-4 border-slate-200 dark:border-[#2A2E33] rounded-full"></div>
          <div class="absolute inset-0 border-4 border-[#F59E0B] rounded-full border-t-transparent animate-spin"></div>
          <LocateFixed class="absolute inset-0 m-auto h-6 w-6 text-[#F59E0B] animate-pulse" />
        </div>
        <h3 class="text-xl font-bold text-slate-800 dark:text-white mb-2">{{ loadingMessage }}</h3>
        <p class="text-sm text-slate-500 dark:text-[#6F767E]">Mohon tunggu sebentar, sistem sedang memproses permintaan Anda.</p>
      </div>
    </div>
...
import { Map as MapIcon, Search, X, ChevronRight, ChevronLeft, Navigation, LayoutDashboard, LogIn, LocateFixed, Sun, Moon, Layers, Activity, Store, Tag, Users, GraduationCap, Landmark } from 'lucide-vue-next';
...
const umkmViewMode = ref<'markers' | 'heatmap_density' | 'heatmap_potential'>('markers');
...
const dashboardRoute = computed(() => {
  try {
    ...
    if (userInfo && userInfo.role) {
      const urlRole = userInfo.role === 'field_officer' ? 'officer' : userInfo.role;
...
const mapStats = computed(() => {
  ...
  if (total === 0) return { total: 0, avgPotential: '0.0', topCategory: '-', levelTinggi: 0, levelSedang: 0, levelRendah: 0, population, schoolsCount, govCount };
...
const routeInfo = ref<{ distance_km: string; duration_min: string } | null>(null);

// Icons setup
const createUmkmIcon = (color: string) => {
  const shopSvg = '<path d="M3 7v4a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V7M2 7l2-4h16l2 4M12 12v9M4 12v9h16v-9"/>';
  return L.divIcon({
    className: '',
    html: `
...
function initMap() {
    ...
    onEachFeature: (feature, layer) => {
      if (feature.properties && feature.properties.name) {
        ...
        layer.bindTooltip(tooltipHtml, {
          permanent: false,
          direction: 'center',
          className: 'bg-white/95 dark:bg-[#1A1D1F]/95 border border-slate-200/50 dark:border-[#2A2E33]/50 rounded-xl shadow-xl !p-2'
        });
      }
      ...
      layer.on('click', () => {
        if (map.value && typeof (layer as any).getBounds === 'function') {
          map.value.fitBounds((layer as any).getBounds(), { padding: [50, 50], animate: true, duration: 1 });
        }
  ...
  settlementLayer.value = L.geoJSON(undefined, { pane: 'polygonsPane', style: settlementStyle });
  tradingLayer.value = L.geoJSON(undefined, { pane: 'polygonsPane', style: tradingStyle });
  
  const pointToLayerMarker = (color: string, svgPath: string) => (feature: any, latlng: L.LatLng) => {
  ...
  const schoolSvg = '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/>';
  const govSvg = '<path d="M3 21h18"/><path d="M9 8h1"/><path d="M9 12h1"/><path d="M9 16h1"/><path d="M14 8h1"/><path d="M14 12h1"/><path d="M14 16h1"/><path d="M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16"/>';
  const tourismSvg = '<path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/>';

  schoolLayer.value = L.geoJSON(undefined, { 
    pointToLayer: pointToLayerMarker('#10b981', schoolSvg),
    onEachFeature: (f, l) => l.bindTooltip(f.properties?.name || 'Sekolah', {
      className: 'bg-white dark:bg-[#1A1D1F] text-[#10b981] font-bold border-l-4 border-[#10b981] border-y border-r border-y-slate-200 border-r-slate-200 dark:border-y-[#2A2E33] dark:border-r-[#2A2E33] px-3 py-1.5 rounded-lg shadow-lg text-xs',
      direction: 'top',
      offset: [0, -32]
    })
  });
  ...
  govLayer.value = L.geoJSON(undefined, { 
    ...
    onEachFeature: (f, l) => l.bindTooltip(f.properties?.name || 'Fasilitas Pemerintahan', {
      className: 'bg-white dark:bg-[#1A1D1F] text-[#10b981] font-bold border-l-4 border-[#10b981] border-y border-r border-y-slate-200 border-r-slate-200 dark:border-y-[#2A2E33] dark:border-r-[#2A2E33] px-3 py-1.5 rounded-lg shadow-lg text-xs',
      direction: 'top',
      offset: [0, -32]
    })
  ...
  tourismLayer.value = L.geoJSON(undefined, { 
    ...
    onEachFeature: (f, l) => l.bindTooltip(f.properties?.name || 'Objek Wisata', {
      className: 'bg-white dark:bg-[#1A1D1F] text-[#10b981] font-bold border-l-4 border-[#10b981] border-y border-r border-y-slate-200 border-r-slate-200 dark:border-y-[#2A2E33] dark:border-r-[#2A2E33] px-3 py-1.5 rounded-lg shadow-lg text-xs',
      direction: 'top',
      offset: [0, -32]
    })
    ...
    if (umkmRes.data && umkmRes.data.features) {
      ...
      allUmkms.value.forEach(u => {
        ...
        if (u.village_id && u.village_name) {
          uniqueVills.set(u.village_id, { id: u.village_id, name: u.village_name });
        }
      });
      
      categories.value = Array.from(uniqueCats).sort();
      villages.value = Array.from(uniqueVills.values()).sort((a: {name: string}, b: {name: string}) => a.name.localeCompare(b.name));
...
async function setMapMode(mode: 'markers' | 'heatmap_density' | 'heatmap_potential') {
  if (!map.value) return;
  ...
  if (mode === 'markers') {
    ...
    // Fetch heatmap data
    const endpoint = mode === 'heatmap_density' ? '/heatmap/umkm' : '/heatmap/potential';
    try {
      const res = await api.get(endpoint);
      if (res.data && res.data.data) {
        heatmapLayer.value = (L as any).heatLayer(res.data.data, {
          radius: 25,
          blur: 15,
          maxZoom: 17,
          pane: 'heatmapPane',
          gradient: mode === 'heatmap_potential' 
            ? { 0.0: 'rgba(0,0,255,0)', 0.3: 'blue', 0.6: 'yellow', 0.8: 'orange', 1.0: 'red' }
            : { 0.0: 'rgba(0,0,255,0)', 0.3: 'cyan', 0.6: 'lime', 0.8: 'yellow', 1.0: 'red' }
        }).addTo(map.value);
      }
    } catch (e) {
...
function renderUmkmMarkers() {
  ...
  filteredUmkms.value.forEach(umkm => {
    ...
    const level = umkm.potential_level ? String(umkm.potential_level).toLowerCase() : '';
...
function handleSearch() {
  ...
  searchResults.value = allUmkms.value.filter(u => 
...
function focusUmkm(umkm: any) {
  ...
  if (map.value && umkm.geometry) {
    map.value.flyTo([umkm.geometry.coordinates[1], umkm.geometry.coordinates[0]], 18, {
      duration: 1.5
    });
  }
}
...
function applyFilters() {
  filteredUmkms.value = allUmkms.value.filter(u => {
    ...
    if (searchQuery.value && !searchResults.value.some(r => r.id === u.id)) {
      if (!u.name.toLowerCase().includes(searchQuery.value.toLowerCase()) && 
...
async function toggleLayer(layerName: string) {
  ...
  if (layerName === 'umkm') {
    if (visibleLayers.value.umkm) {
      ...
      if (umkmLayer.value) map.value.removeLayer(umkmLayer.value as L.LayerGroup);
      if (heatmapLayer.value) {
        map.value.removeLayer(heatmapLayer.value);
      }
    }
  ...
  if (visibleLayers.value[layerName as keyof typeof visibleLayers.value]) {
    try {
      ...
      visibleLayers.value[layerName as keyof typeof visibleLayers.value] = false;
    }
  } else {
    if (layer) {
  ...
  navigator.geolocation.getCurrentPosition(
    (position) => {
      ...
      if (lat > -1.7 || lat < -2.1 || lng < 105.9 || lng > 106.3) {
        console.warn("User berada di luar Sungailiat, menggunakan lokasi simulasi (Pusat Kota).");
        lat = -1.8841;
        lng = 106.1136;
      }
      ...
      if (map.value) {
        ...
        marker.bindPopup("<b>Lokasi Anda</b>", { className: isDark.value ? 'dark-popup' : 'light-popup' }).addTo(routeLayer.value as L.LayerGroup);
      }
    ...
    (error) => {
      ...
      setTimeout(() => {
        ...
        if (map.value) {
          ...
          const marker = L.marker([lat, lng], { icon: userIcon });
          (marker as any).isUserMarker = true;
          marker.bindPopup("<b>Lokasi Simulasi</b>", { className: isDark.value ? 'dark-popup' : 'light-popup' }).addTo(routeLayer.value as L.LayerGroup);
        }
  ...
  if (!userLocation.value) {
    ...
    const checkLocation = setInterval(() => {
      if (userLocation.value) {
        ...
        executeRouting(userLocation.value.lat, userLocation.value.lng, destLat, destLng);
      }
    }, 500);
...
async function executeRouting(startLat: number, startLng: number, destLat: number, destLng: number) {
      ...
      if (routeLayer.value) {
        ...
        routeGeoJson.bindTooltip(
          ...
          </div>`,
          {
            permanent: true,
            direction: 'center',
            className: 'bg-white/95 dark:bg-[#1A1D1F]/95 border border-slate-200/50 dark:border-[#2A2E33]/50 shadow-lg rounded-xl px-3 py-1.5'
          }
        );
...
.dark .custom-scrollbar::-webkit-scrollbar-thumb { background: #2A2E33; }
.custom-scrollbar::-webkit-scrollbar-thumb:hover { background: #94a3b8; }
.dark .custom-scrollbar::-webkit-scrollbar-thumb:hover { background: #F59E0B; }
